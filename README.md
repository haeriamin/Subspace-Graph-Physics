...
* We train the graph network (GN) model in subspace by performing Principal Component Analysis (PCA). This enables GN to be trained using a single desktop GPU with moderate VRAM (∼10GB) for large 3D configurations.

* The training datasets have been generated by our [Material Point Method (MPM)](https://github.com/haeriamin/MPM-NGF){:target="_blank"}.
