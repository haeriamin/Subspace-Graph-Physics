...
`python -m subspace_data.run_tfrecord`
                    ...
                    if c == 197: # and speed != 0.01:
                        ...
                        for frame in range(1, frames+1):
                            ...
                            for particle in range(1, particles):
                                ...
                                # Particle position at each frame (reflected about x=0.5)
                                ...
                                # for x in particle_pos_frame[particle-1]:
                                #     # print(x)
                                #     if np.isnan(x):
                                #         print(frame)
                                #         print(particle)

                            # Rigid body force (reflected)
                            ...
                            # Extra frame in the beginning (reflected)
                            if frame == 1:
                                particle_pos.append(particle_pos_frame)
                                rigid_body_force.append([
                                    # - round(data_frame['col0'][0]/(scale_dim**3), 6),
                            ...
                            if frame % 10 == 0:
                                print(c, 'Part I:', round(frame/frames, 3)*100, '%')
                        ...
                        for frame in range(1, frames+1):
                            ...
                            if frame % 10 == 0:
                                print(c, 'Part II:', round(frame/frames, 3)*100, '%')
                        del nparray
                        del particle_pos
